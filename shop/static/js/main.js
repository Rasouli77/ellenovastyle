    ...
    jQuery(document).ready(function() {
        ...
        function sidebarSearch() {
            ...
            searchTrigger.on('click', function(e) {
                e.preventDefault();
                container.addClass('inside');
                document.querySelector(".search-desktop-click-capture").style.display = "block";
            });
            endTriggersearch.on('click', function() {
                container.removeClass('inside');
                document.querySelector(".search-desktop-click-capture").style.display = "none";
            });
        };
        sidebarSearch();
        ...
        $('[data-countdown]').each(function() {
            ...
            $this.countdown(finalDate, function(event) {
                $this.html(event.strftime('<div class="count"><p>%D</p><span>روزها</span></div><div class="count"><p>%H</p> <span>ساعت</span></div><div class="count"><p>%M</p> <span>دقیقه</span></div><div class="count"> <p>%S</p> <span>ثانیه</span></div>'));
            });
        });
     ...
     $('.testimonial__slider__active').slick({
        ...
        arrows:false,
        rtl:true,
        prevArrow:'<span class="prev_class"> <i class="fas fa-chevron-right"></i></span>',
        nextArrow: '<span class="next_class"><i class="fas fa-chevron-left"></i></span>',
        responsive: [{
            breakpoint: 1367,
            settings: {
                slidesToShow:1,
...
// if (window.innerWidth < 767) {
    ...
    filterBtn.addEventListener("click", function() {
        const sibling = document.getElementById("filter-options-buttons");
